            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 center-col col-sm-12 text-center">
                        <form action="#subscribe-section6" method="post">
                            <input type="text" name="name" id="name" data-email="required" placeholder="Treść pytania" class="big-input bg-white alt-font border-radius-4" required>
                            <input type="text" name="email" id="email" data-email="required" placeholder="Twój email" class="big-input bg-white alt-font border-radius-4" required>
